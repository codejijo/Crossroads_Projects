...
btn_zero.pack(side=LEFT, expand=True, fill="both", ipadx=38)
...
btn_equal.pack(side=LEFT, expand=True, fill="both",ipadx=72)
btndot = Button(btnframe[4], text=".", command=lambda: show("."), font=("Verdana", 22,'bold'), relief=GROOVE, border=0,background="#2a9d8f", fg="#fff")
btndot.pack(side=LEFT, expand=True, fill="both", ipadx=12)
